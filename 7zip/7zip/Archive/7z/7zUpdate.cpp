    ...
    bool bcj2Filter, CCompressionMethodMode &exeMethod)
{
  ...
  if (bcj2Filter)
  {
      ...
      return false;
    {
      ...
      property.Value.ulVal = kAlgorithmForBCJ2_LZMA;
    ...
    }
    {
      ...
      property.Value.pwszVal = (LPWSTR)kMatchFinderForBCJ2_LZMA;
      methodFull.CoderProperties.Add(property);
    }
    {
      CProperty property;
      ...
      property.Value.vt = VT_UI4;
      property.Value.ulVal = kDictionaryForBCJ2_LZMA;
      methodFull.CoderProperties.Add(property);
    }
    {
      CProperty property;
      ...
      property.Value.vt = VT_UI4;
      property.Value.ulVal = kNumFastBytesForBCJ2_LZMA;
      methodFull.CoderProperties.Add(property);
    }
