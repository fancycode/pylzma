...
{
  NOS::NSynchronization::CAutoResetEvent *CompressEvent;
  HANDLE ExitEvent;
  NOS::NSynchronization::CAutoResetEvent *CompressionCompletedEvent;
...
private:
  ...
  NOS::CThread _mainThread;

  NOS::NSynchronization::CAutoResetEvent _startCompressingEvent;
  CRecordVector<HANDLE> _compressingCompletedEvents;
  NOS::NSynchronization::CAutoResetEvent _compressingFinishedEvent;

  NOS::NSynchronization::CManualResetEvent _exitEvent;
